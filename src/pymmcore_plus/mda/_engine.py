...
from pymmcore_plus.mda.metadata._dicts import FrameMetaDictV1, SummaryMetaDictV1
...
class MDAEngine(PMDAEngine):
    ...
    def __init__(
        ...
        *,
        ...
        summary_metadata_format: str | MetaDataGetter = SummaryMetaDictV1.from_core,
        summary_metadata_version: str = "1.0",
        frame_metadata_format: str | MetaDataGetter = FrameMetaDictV1.from_core,
