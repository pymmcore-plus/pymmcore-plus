...
| **`PYMM_LOG_FILE`**   | Logfile location (`0`/`false`/`no`/`none` disables file logging). | `pymmcore-plus.log` in the pymmcore-plus [log directory](./guides/logging.md#customizing-logging) |
